...
def lcb_official_prompt_plus_cot(question_content, starter_code):
    prompt = f"### Question:\n{question_content}\n\n"
...
def main():
    ...
    total = 0
    right = 0
    output_path = "./cot_solve_codes_ds"
    ...
    for i, problem in enumerate(problems):
        ...
        user_prompt = lcb_official_prompt_plus_cot(problem.description, problem.starter_code)
